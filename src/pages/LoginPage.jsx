...
import { Phone, ArrowRight, CheckCircle2, Lock, ShieldCheck, Sparkles, ChevronRight } from 'lucide-react';
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-[80vh] flex flex-col justify-center items-center px-4 py-12 bg-[#FAF8F5]">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
        {/* Myntra-style Header */}
        <div className="bg-[#6B1518] text-white p-8 relative overflow-hidden">
          <span className="text-[10px] tracking-widest font-extrabold text-[#D3923A] uppercase block">
            {BRAND.name} Authentication
          </span>
          ...
          <div className="absolute -right-6 -bottom-6 w-28 h-28 rounded-full bg-[#D3923A]/15 pointer-events-none" />
        </div>

        {/* Form Body */}
        <div className="p-7 space-y-5">
          {errorMsg && (
            <div className="p-3 rounded-xl bg-red-50 text-red-700 text-xs font-semibold border border-red-100">
              {errorMsg}
            </div>
          )}
            ...
            <form onSubmit={handleVerifyOtp} className="space-y-5">
              <div className="space-y-2 text-center">
                ...
                <p className="text-[10px] text-emerald-700 font-bold mt-1">
                  ✓ Demo OTP <span className="bg-emerald-100 px-1.5 py-0.5 rounded text-emerald-900">1234</span> auto-filled.
                </p>
              </div>
