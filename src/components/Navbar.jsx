...
import { Search, ShoppingBag, Heart, Menu, X, Phone, MapPin, ChevronRight, MessageCircle, User, ArrowLeft } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2.5 xl:py-3">
        <div className="flex items-center justify-between gap-2 sm:gap-4">
          ...
          <div className="flex items-center gap-1.5 sm:gap-3">
            {/* Search Icon (Hidden on /categories since dedicated search field is already on that page) */}
            {!isCategoriesPage && (
              <button
